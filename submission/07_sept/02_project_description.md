...
OOT-период: 2025-07-01 и позже. Примечание: после установки OOT_START на этом периоде проверялось несколько вариантов индикатора — полная независимость не гарантирована. N(OOT) сигналов: KGS=3, TJS=3, UZS=5, AMD=3, KZT=0. CI вычислен на полной выборке (OOT N слишком мал для block bootstrap).
