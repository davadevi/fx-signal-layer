...
def slide_open_questions(prs):
    ...
    questions = [
        (
            ...
            "Проверен relaxed вариант (confirm_days=0): 0.37–0.42 сигн./нед (6–7×), "
            "но CI < 1.0 на всех коридорах и bps отрицательный (клиент теряет 5–35 бп). "
            "c0 статистически и экономически не валидирован — c2 единственный обоснованный выбор."
        ),
        (
            "bps подтверждён положительным",
            "Экономический эффект c2: KGS +41/+64 бп (h=5/10), TJS +69/+96 бп, AMD +26/+52 бп. "
            "Сигнал идентифицирует локальное дно — рубль укреплялся 2 дня, затем откатывается. "
            "Клиент, действующий по сигналу, платит на 40–96 бп меньше среднего курса следующих 10 дней."
        ),
        (
            "AMD — малая выборка",
